...
class UpdateAccountIntegrationTest :  AutoCloseKoinTest(){
    ...
    fun setUp() {
        val vmModule = module {
            factory { UpdateAccountViewModel(get(), get(), get()) }
    ...
    @Test fun updateAccountServerError(){
    ...
    @Test fun updateAccountNetworkError(){
    ...
    fun updateUserSuccess(){
        ...
        verify(observer).onChanged(UpdateAccountViewModel.UiModel.UpdateAccountContent(mockedUserUpdate))
